...
export function NetworkRail(props: NetworkRailProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ width: 32, height: 1, background: 'var(--border)', margin: '2px 0 12px' }} />

      <div className="flex flex-col items-center gap-3 overflow-y-auto flex-1 w-full" style={{ scrollbarWidth: 'none' }}>
        {networks.map((n) => (
          <div
            key={n.id}
            draggable
